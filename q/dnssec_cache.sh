...
queryL2(){
  ./q -port 53 -tcp -dnssec -check -output="${1:-""}" -chain="3" @64.227.123.153 $l2
}

queryL3(){
  ./q -port 53 -tcp -dnssec -check -output="${1:-""}" -chain="4" @64.227.123.153 $l3
}

queryL4(){
  ./q -port 53 -tcp -dnssec -check -output="${1:-""}" -chain="5" @64.227.123.153 $l4
}

queryL5(){
  ./q -port 53 -tcp -dnssec -check -output="${1:-""}" -chain="6" @64.227.123.153 $l5
}

queryL6(){
  ./q -port 53 -tcp -dnssec -check -output="${1:-""}" -chain="7" @64.227.123.153 $l6
}
